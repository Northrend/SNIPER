...
# ---------------------------------------------------------------
#
# Dummy dataset with coco api
# For SNIPER training and test
# Modified: Northrend@github.com
# Update: 2018-07-19
# 
...
class dummy(IMDB):
    def __init__(self, image_set, root_path, data_path, result_path=None, mask_size=-1, binary_thresh=None, load_mask=False, dataset_dummy_name='COCO'):
        """
        ...
        """
        super(dummy, self).__init__(dataset_dummy_name, image_set, root_path, data_path, result_path)  # dataset_dummy_name=juggdet

        self.root_path = root_path
        self.data_path = data_path
        self.dataset_dummy_name = dataset_dummy_name
        self._path_map = {
            'juggdet_0503_train': {
    ...
    def image_path_from_index(self, index):
        """ example: ./data/juggdet/juggdet_0503/Image/Image-tupu-2016-11-03-12-40-3939.jpg """
